    ...
    <div class="view view-main view-init ios-edges" data-url="/">
        ...
        <div class="navbar navbar-"><div class="navbar-inner sliding navbar-current">
                <div class="left" style="">
                    <a href="#" class="link back" onclick="window.location.href='kenangan.php'">
            ...
            <div class="recommended product segments-bottom">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        {
                            $cari = $_GET['cari'];
                            $querytabel = "SELECT * FROM data_kenangan where caption like '%$cari%' order by tanggal desc LIMIT 0,10";
                        }
                        else
                        {
                            $querytabel = "SELECT * FROM data_kenangan order by tanggal desc LIMIT 0,10";
                        }
                            ...
                            <div class="col-100" style=" margin-top: 21px;">
                                <div class="content content-shadow-product">
                                    ...
                                    <div class="text">
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <i  onclick="window.location.href='detail.php?id_kenangan=<?php echo $id_kenangan;?>&id_alumni=<?php echo $id;?>';" class="fa fa-comment" style="font-size: 18px;"></i>
                                        <br>
                                        <br>
                                        <p  class="location" style="font-size: 10px;font-weight: 100;">Tampilkan <?php total("","select * from data_komentar_kenangan where id_kenangan='$id_kenangan'");?> Komentar</p>
