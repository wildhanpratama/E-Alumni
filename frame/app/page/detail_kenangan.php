                ...
                <div class="product-details segments">
                    <div class="container">
                        ...
                        <div class="slider-p-details">
                            <div data-pagination="{&quot;el&quot;: &quot;.swiper-pagination&quot;}"
                                ...
                                <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                    ...
                                    <?php
                                    $id_kenangan = $_GET['id_kenangan'];
                                    $id_alumni = $_GET['id_alumni'];

                                    $querytabel = "SELECT * FROM data_kenangan where id_kenangan='$id_kenangan'";
                        ...
                        <div class="wrapper-content">
                            ...
                            $querytabel2 = "SELECT * FROM data_komentar_kenangan where id_kenangan='$id_kenangan' order by id_komentar_kenangan desc";
                            ...
                            <div class="wrap-info">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input-wrap">
                                        <form action="komen_kenangan.php">
                                            <input  type="hidden" value="<?php echo $_GET['id_kenangan'];?>" name="id_kenangan">
