...
public class data_akreditas_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_akreditas_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data_akreditas_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_akreditas_sqlite_activity.this);
        data_akreditas_tampil.setLayoutManager(layoutManager);
        fetch_data_akreditas_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_akreditas_sqlite_activity.this, data_akreditas_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_akreditas_sqlite();
                Toast.makeText(data_akreditas_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_akreditas_sqlite(){
        dbHandler = new data_akreditas_sqlite_dbhandler( data_akreditas_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_akreditas_sqlite();
        adapter = new data_akreditas_sqlite_adapter(data_akreditas_sqlite_activity.this, datalist );
        ...
        if (adapter.getItemCount() == 0){
            ...
            data_akreditas_tampil.addOnItemTouchListener(
                    new data_akreditas_sqlite_recyclerclick(getApplicationContext(), new data_akreditas_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_akreditas_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_akreditas_sqlite_activity.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_akreditas_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_akreditas_sqlite_dbhandler( data_akreditas_sqlite_activity.this);
        datalist = dbHandler.get_data_akreditas_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_akreditas_sqlite_adapter(data_akreditas_sqlite_activity.this, datalist );
        data_akreditas_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
