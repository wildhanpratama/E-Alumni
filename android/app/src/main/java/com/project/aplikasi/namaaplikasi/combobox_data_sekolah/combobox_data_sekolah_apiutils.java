...
public class combobox_data_sekolah_apiutils {
    public static combobox_data_sekolah_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create(combobox_data_sekolah_apiservice.class);
    }
}
