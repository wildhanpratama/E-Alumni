...
public class data_like_kenangan_tambah_v2_adapter extends BaseAdapter {
...
;
    ...
    public data_like_kenangan_tambah_v2_adapter(Activity activity, ArrayList<data_like_kenangan_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_like_kenangan_tambah_v2_tampil, null);
        }
        ...
        if (p != null) {
			...
			loading = new loading((data_like_kenangan_tambah_v2)activity);
            ...
            id_like_kenangan.setText(""+data.get(position).get_id_like_kenangan());
