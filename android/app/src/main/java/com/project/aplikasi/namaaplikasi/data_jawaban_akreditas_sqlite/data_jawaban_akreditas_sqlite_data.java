...
public class data_jawaban_akreditas_sqlite_data {
    ...
    public data_jawaban_akreditas_sqlite_data() {
    }

    public data_jawaban_akreditas_sqlite_data(String id_jawaban_akreditas
