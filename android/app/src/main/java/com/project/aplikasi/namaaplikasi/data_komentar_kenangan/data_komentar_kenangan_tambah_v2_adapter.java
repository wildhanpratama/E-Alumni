...
public class data_komentar_kenangan_tambah_v2_adapter extends BaseAdapter {
...
;
    ...
    public data_komentar_kenangan_tambah_v2_adapter(Activity activity, ArrayList<data_komentar_kenangan_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_komentar_kenangan_tambah_v2_tampil, null);
        }
        ...
        if (p != null) {
			...
			loading = new loading((data_komentar_kenangan_tambah_v2)activity);
            ...
            id_komentar_kenangan.setText(""+data.get(position).get_id_komentar_kenangan());
