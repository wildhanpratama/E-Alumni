...
public class data_sekolah_tambah_v2_adapter extends BaseAdapter {
...
;
    ...
    public data_sekolah_tambah_v2_adapter(Activity activity, ArrayList<data_sekolah_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_sekolah_tambah_v2_tampil, null);
        }
        ...
        if (p != null) {
			...
			loading = new loading((data_sekolah_tambah_v2)activity);
            ...
            nama_sekolah.setText(""+data.get(position).get_nama_sekolah());
