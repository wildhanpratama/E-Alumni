...
public class data_akreditas_sqlite_tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_akreditas.setText( config_global.generate_id( data_akreditas_sqlite_tambah.this,"data_akreditas") );
        ...
        button_tambahdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_akreditas_sqlite_tambah.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.tambah_data_akreditas_sqlite( new data_akreditas_sqlite_data(
                    ...
                    adapter = new data_akreditas_sqlite_adapter( data_akreditas_sqlite_tambah.this, data_akreditas_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_akreditas_sqlite_tambah.this, "Berhasil Menambahkan Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
