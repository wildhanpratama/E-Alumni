...
public class data_alumni_activity_v2 extends AppCompatActivity {

    ArrayList<data_alumni_apidata> result = new ArrayList<>();
    data_alumni_adapter_v2 adapter;
    RecyclerView data_alumni_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_alumni_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_alumni_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(data_alumni_activity_v2.this,
                        data_alumni_tambah.class);
    ...
    public void fetch_data_alumni() {

        if (isRefresh) {
            loading.showDialog(1, "Please Wait", "Loading Data..");
        }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_alumni(
                "", "", "", "", "", "", "Bearer " + token
        ).enqueue(new Callback<data_alumni_api>() {
            @Override
            public void onResponse(Call<data_alumni_api> call, Response<data_alumni_api> response) {

                data_alumni_api response_data = response.body();
                adapter.updateResults(response_data.get_data_alumni());

                int jumlah_data = data_alumni_tampil.getAdapter().getItemCount();
                if (jumlah_data < 1) {
                    gif_no_data();
                } else {
                    hidden_gif();
                ...
                if (isRefresh) {
                    Toast.makeText(data_alumni_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_alumni_api> call, Throwable t) {
                if (isRefresh) {
                    loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_alumni_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_alumni_activity_v2.this,
