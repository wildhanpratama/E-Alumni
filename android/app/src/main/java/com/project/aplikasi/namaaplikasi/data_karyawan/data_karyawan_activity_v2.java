...
public class data_karyawan_activity_v2 extends AppCompatActivity {

    ArrayList<data_karyawan_apidata> result = new ArrayList<>();
    data_karyawan_adapter_v2 adapter;
    RecyclerView data_karyawan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_karyawan_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_karyawan_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_karyawan_activity_v2.this,
                        data_karyawan_tambah.class);
    ...
    public void fetch_data_karyawan(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_karyawan(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_karyawan_api>() {
            @Override
            public void onResponse(Call<data_karyawan_api> call, Response<data_karyawan_api> response) {
				
                data_karyawan_api response_data = response.body();
                adapter.updateResults(response_data.get_data_karyawan());

				int jumlah_data = data_karyawan_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_karyawan_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_karyawan_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_karyawan_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_karyawan_activity_v2.this,
