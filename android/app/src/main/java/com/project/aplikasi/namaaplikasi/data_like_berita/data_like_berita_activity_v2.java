...
public class data_like_berita_activity_v2 extends AppCompatActivity {

    ArrayList<data_like_berita_apidata> result = new ArrayList<>();
    data_like_berita_adapter_v2 adapter;
    RecyclerView data_like_berita_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_like_berita_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_like_berita_activity_v2.this);
        ...
        fetch_data_like_berita();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( data_like_berita_activity_v2.this,
                        data_like_berita_tambah.class);
    ...
    public void fetch_data_like_berita(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_like_berita(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_like_berita_api>() {
            @Override
            public void onResponse(Call<data_like_berita_api> call, Response<data_like_berita_api> response) {
				
                data_like_berita_api response_data = response.body();
                adapter.updateResults(response_data.get_data_like_berita());

				int jumlah_data = data_like_berita_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_like_berita_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_like_berita_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_like_berita_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_like_berita_activity_v2.this,
