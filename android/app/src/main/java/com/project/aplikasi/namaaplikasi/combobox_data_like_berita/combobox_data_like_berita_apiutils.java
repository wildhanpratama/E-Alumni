...
public class combobox_data_like_berita_apiutils {
    public static combobox_data_like_berita_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create(combobox_data_like_berita_apiservice.class);
    }
}
