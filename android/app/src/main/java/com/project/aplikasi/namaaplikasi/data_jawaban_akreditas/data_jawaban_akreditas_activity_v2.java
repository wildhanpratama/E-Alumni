...
public class data_jawaban_akreditas_activity_v2 extends AppCompatActivity {

    ArrayList<data_jawaban_akreditas_apidata> result = new ArrayList<>();
    data_jawaban_akreditas_adapter_v2 adapter;
    RecyclerView data_jawaban_akreditas_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_jawaban_akreditas_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_jawaban_akreditas_activity_v2.this);
        ...
        fetch_data_jawaban_akreditas();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( data_jawaban_akreditas_activity_v2.this,
                        data_jawaban_akreditas_tambah.class);
    ...
    public void fetch_data_jawaban_akreditas(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_jawaban_akreditas(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_jawaban_akreditas_api>() {
            @Override
            public void onResponse(Call<data_jawaban_akreditas_api> call, Response<data_jawaban_akreditas_api> response) {
				
                data_jawaban_akreditas_api response_data = response.body();
                adapter.updateResults(response_data.get_data_jawaban_akreditas());

				int jumlah_data = data_jawaban_akreditas_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_jawaban_akreditas_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_jawaban_akreditas_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_jawaban_akreditas_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_jawaban_akreditas_activity_v2.this,
