...
public class data_komentar_berita_tambah_v2 extends AppCompatActivity {
...
;
    ...
    data_komentar_berita_tambah_v2_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.data_komentar_berita_tambah_v2 );
        ...
        data_komentar_berita_tampil = (ListView) findViewById(R.id.cvdata_komentar_berita);

        adapter = new data_komentar_berita_tambah_v2_adapter(this, result);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
				...
				id_komentar_berita.setText( config_global.generate_id(data_komentar_berita_tambah_v2.this,"data_komentar_berita") );
				validasi ="berhasil";
                validasiForm((ViewGroup) findViewById(R.id.group));
                if (validasi =="gagal") {
                    loading.hideDialog();
					Toast.makeText( data_komentar_berita_tambah_v2.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
					
                }  else {
					String token = "Bearer " + new config_global().ambil(data_komentar_berita_tambah_v2.this);
					mAPIService.proses_simpan_data_komentar_berita(id_komentar_berita.getText().toString()
						...
						public void onResponse(Call<Object> call, Response<Object> response) {
							Toast.makeText( data_komentar_berita_tambah_v2.this, "Berhasil Disimpan",
									Toast.LENGTH_LONG).show();
							result.add(new data_komentar_berita_apidata(
						...
						public void onFailure(Call<Object> call, Throwable t) {
							Toast.makeText( data_komentar_berita_tambah_v2.this, "Gagal Disimpan",
									Toast.LENGTH_LONG).show();
									loading.hideDialog();
						}
					});
