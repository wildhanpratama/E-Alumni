...
public class data_like_kenangan_tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                id_like_kenangan.setText( config_global.generate_id(data_like_kenangan_tambah.this,"data_like_kenangan") );
                validasi ="berhasil";
                validasiForm((ViewGroup) findViewById(R.id.group));
                if (validasi =="gagal") {
                    loading.hideDialog();
					Toast.makeText( data_like_kenangan_tambah.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    
                }  else {
					
				String token = "Bearer " + new config_global().ambil(data_like_kenangan_tambah.this);
                mAPIService.proses_simpan_data_like_kenangan(id_like_kenangan.getText().toString()
                    ...
                    public void onResponse(Call<Object> call, Response<Object> response) {
                        Toast.makeText( data_like_kenangan_tambah.this, "Berhasil Disimpan", Toast.LENGTH_LONG).show();
                        setResult(RESULT_OK);
                    ...
                    public void onFailure(Call<Object> call, Throwable t) {
                        Toast.makeText( data_like_kenangan_tambah.this, "Gagal Disimpan", Toast.LENGTH_LONG).show();
						 loading.hideDialog();
                    }
                });
				}
