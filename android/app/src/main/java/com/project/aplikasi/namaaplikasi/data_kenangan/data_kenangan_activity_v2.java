...
public class data_kenangan_activity_v2 extends AppCompatActivity {

    ArrayList<data_kenangan_apidata> result = new ArrayList<>();
    data_kenangan_adapter_v2 adapter;
    RecyclerView data_kenangan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_kenangan_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_kenangan_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_kenangan_activity_v2.this,
                        data_kenangan_tambah.class);
    ...
    public void fetch_data_kenangan(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_kenangan(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_kenangan_api>() {
            @Override
            public void onResponse(Call<data_kenangan_api> call, Response<data_kenangan_api> response) {
				
                data_kenangan_api response_data = response.body();
                adapter.updateResults(response_data.get_data_kenangan());

				int jumlah_data = data_kenangan_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_kenangan_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_kenangan_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_kenangan_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_kenangan_activity_v2.this,
