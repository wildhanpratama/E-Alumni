...
public class combobox_data_kenangan_apiutils {
    public static combobox_data_kenangan_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create(combobox_data_kenangan_apiservice.class);
    }
}
