...
public class data_komentar_berita_sqlite_adapter extends RecyclerView.Adapter<data_komentar_berita_sqlite_adapter.data_komentar_berita_ViewHolder> {
    ...
    public data_komentar_berita_sqlite_adapter(Activity activity,List<data_komentar_berita_sqlite_data> datalist) {
        this.activity = activity;
        this.datalist = datalist;
    }

    @Override
    public data_komentar_berita_ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.data_komentar_berita_tampil_v2, parent, false);
        data_komentar_berita_ViewHolder mahasiswaViewHolder = new data_komentar_berita_ViewHolder(view);
        return mahasiswaViewHolder;
    }

    @Override
    public void onBindViewHolder(data_komentar_berita_ViewHolder holder, int position) {
        holder.txt_result_id_komentar_berita.setText("id_komentar_berita : " + datalist.get(position).get_id_komentar_berita());
    ...
    public class data_komentar_berita_ViewHolder extends RecyclerView.ViewHolder {
        TextView txt_result_id_komentar_berita;
       ...
       TextView txt_result_komentar;
        ...
        public data_komentar_berita_ViewHolder(final View itemView) {
            super(itemView);
            dbHandler = new data_komentar_berita_sqlite_dbhandler(activity);
            txt_result_id_komentar_berita = (TextView) itemView.findViewById(R.id.id_komentar_berita);
            ...
            linearEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   bundle.putString("komentar", datalist.get(getAdapterPosition()).get_komentar());
                    ...
                    Intent intent = new Intent(activity, data_komentar_berita_sqlite_edit.class);
                    ...
                    BackAlertDialog.setPositiveButton("Ya",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    dbHandler.hapus_data_komentar_berita_sqlite( new data_komentar_berita_sqlite_data(
                                    ...
                                    adapter = new data_komentar_berita_sqlite_adapter( activity, data_komentar_berita_sqliteList );
                                    adapter.notifyDataSetChanged();
                                    Toast.makeText( activity, "Berhasil Terhapus", Toast.LENGTH_SHORT ).show();
                                    ((data_komentar_berita_sqlite_activity)activity).fetch_data_komentar_berita_sqlite();
                                }
                            });
