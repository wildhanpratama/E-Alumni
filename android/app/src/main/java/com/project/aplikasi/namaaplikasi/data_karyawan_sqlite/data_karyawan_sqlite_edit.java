...
public class data_karyawan_sqlite_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_editdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_karyawan_sqlite_edit.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.update_data_karyawan_sqlite( new data_karyawan_sqlite_data(
                    ...
                    adapter = new data_karyawan_sqlite_adapter( data_karyawan_sqlite_edit.this, data_karyawan_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_karyawan_sqlite_edit.this, "Berhasil Mengupdate Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
