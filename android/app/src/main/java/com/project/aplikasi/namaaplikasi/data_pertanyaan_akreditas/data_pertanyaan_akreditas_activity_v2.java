...
public class data_pertanyaan_akreditas_activity_v2 extends AppCompatActivity {

    ArrayList<data_pertanyaan_akreditas_apidata> result = new ArrayList<>();
    data_pertanyaan_akreditas_adapter_v2 adapter;
    RecyclerView data_pertanyaan_akreditas_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_pertanyaan_akreditas_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_pertanyaan_akreditas_activity_v2.this);
        ...
        fetch_data_pertanyaan_akreditas();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( data_pertanyaan_akreditas_activity_v2.this,
                        data_pertanyaan_akreditas_tambah.class);
    ...
    public void fetch_data_pertanyaan_akreditas(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_pertanyaan_akreditas(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_pertanyaan_akreditas_api>() {
            @Override
            public void onResponse(Call<data_pertanyaan_akreditas_api> call, Response<data_pertanyaan_akreditas_api> response) {
				
                data_pertanyaan_akreditas_api response_data = response.body();
                adapter.updateResults(response_data.get_data_pertanyaan_akreditas());

				int jumlah_data = data_pertanyaan_akreditas_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_pertanyaan_akreditas_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_pertanyaan_akreditas_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_pertanyaan_akreditas_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_pertanyaan_akreditas_activity_v2.this,
