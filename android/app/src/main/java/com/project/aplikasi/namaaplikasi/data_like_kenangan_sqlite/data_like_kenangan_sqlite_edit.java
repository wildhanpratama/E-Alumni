...
public class data_like_kenangan_sqlite_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_editdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_like_kenangan_sqlite_edit.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.update_data_like_kenangan_sqlite( new data_like_kenangan_sqlite_data(
                    ...
                    adapter = new data_like_kenangan_sqlite_adapter( data_like_kenangan_sqlite_edit.this, data_like_kenangan_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_like_kenangan_sqlite_edit.this, "Berhasil Mengupdate Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
