...
public class data_sekolah_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_sekolah_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_sekolah_activity_v2);
        ...
        data_sekolah_tampil = (RecyclerView) findViewById(R.id.data_sekolah_tampil);
        data_sekolah_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_sekolah_sqlite_activity.this);
        data_sekolah_tampil.setLayoutManager(layoutManager);
        fetch_data_sekolah_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_sekolah_sqlite_activity.this, data_sekolah_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_sekolah_sqlite();
                Toast.makeText(data_sekolah_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_sekolah_sqlite(){
        dbHandler = new data_sekolah_sqlite_dbhandler( data_sekolah_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_sekolah_sqlite();
        adapter = new data_sekolah_sqlite_adapter(data_sekolah_sqlite_activity.this, datalist );
        data_sekolah_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        if (adapter.getItemCount() == 0){

            data_sekolah_tampil.setVisibility(View.GONE);
        } else {

            data_sekolah_tampil.setVisibility(View.VISIBLE);
            data_sekolah_tampil.addOnItemTouchListener(
                    new data_sekolah_sqlite_recyclerclick(getApplicationContext(), new data_sekolah_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_sekolah_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_sekolah_sqlite_activity.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.data_sekolah_pencarian, null);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_sekolah_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_sekolah_sqlite_dbhandler( data_sekolah_sqlite_activity.this);
        datalist = dbHandler.get_data_sekolah_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_sekolah_sqlite_adapter(data_sekolah_sqlite_activity.this, datalist );
        data_sekolah_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
