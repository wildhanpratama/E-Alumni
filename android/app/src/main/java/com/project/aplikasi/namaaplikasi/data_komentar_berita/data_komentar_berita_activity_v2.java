...
public class data_komentar_berita_activity_v2 extends AppCompatActivity {

    ArrayList<data_komentar_berita_apidata> result = new ArrayList<>();
    data_komentar_berita_adapter_v2 adapter;
    RecyclerView data_komentar_berita_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_komentar_berita_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_komentar_berita_activity_v2.this);
        ...
        fetch_data_komentar_berita();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( data_komentar_berita_activity_v2.this,
                        data_komentar_berita_tambah.class);
    ...
    public void fetch_data_komentar_berita(){
		
		if (isRefresh){
			loading.showDialog(1,"Please Wait","Loading Data..");
          }
        String token = new config_global().ambil(this);
        mAPIService.tampil_data_komentar_berita(
                "","", "", "","","", "Bearer "+token
        ).enqueue(new Callback<data_komentar_berita_api>() {
            @Override
            public void onResponse(Call<data_komentar_berita_api> call, Response<data_komentar_berita_api> response) {
				
                data_komentar_berita_api response_data = response.body();
                adapter.updateResults(response_data.get_data_komentar_berita());

				int jumlah_data = data_komentar_berita_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_komentar_berita_activity_v2.this, "Data Berhasil Diperbarui",
            ...
            @Override
            public void onFailure(Call<data_komentar_berita_api> call, Throwable t) {
				if (isRefresh){
					loading.hideDialog();
                    isRefresh = false;
                }
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_komentar_berita_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_komentar_berita_activity_v2.this,
