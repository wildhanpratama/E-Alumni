...
public class data_pertanyaan_akreditas_tambah_v2 extends AppCompatActivity {
...
;
    ...
    data_pertanyaan_akreditas_tambah_v2_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.data_pertanyaan_akreditas_tambah_v2 );
        ...
        data_pertanyaan_akreditas_tampil = (ListView) findViewById(R.id.cvdata_pertanyaan_akreditas);

        adapter = new data_pertanyaan_akreditas_tambah_v2_adapter(this, result);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
				...
				id_pertanyaan_akreditas.setText( config_global.generate_id(data_pertanyaan_akreditas_tambah_v2.this,"data_pertanyaan_akreditas") );
				validasi ="berhasil";
                validasiForm((ViewGroup) findViewById(R.id.group));
                if (validasi =="gagal") {
                    loading.hideDialog();
					Toast.makeText( data_pertanyaan_akreditas_tambah_v2.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
					
                }  else {
					String token = "Bearer " + new config_global().ambil(data_pertanyaan_akreditas_tambah_v2.this);
					mAPIService.proses_simpan_data_pertanyaan_akreditas(id_pertanyaan_akreditas.getText().toString()
						...
						public void onResponse(Call<Object> call, Response<Object> response) {
							Toast.makeText( data_pertanyaan_akreditas_tambah_v2.this, "Berhasil Disimpan",
									Toast.LENGTH_LONG).show();
							result.add(new data_pertanyaan_akreditas_apidata(
						...
						public void onFailure(Call<Object> call, Throwable t) {
							Toast.makeText( data_pertanyaan_akreditas_tambah_v2.this, "Gagal Disimpan",
									Toast.LENGTH_LONG).show();
									loading.hideDialog();
						}
					});
