...
public class combobox_data_akreditas_apiutils {
    public static combobox_data_akreditas_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create(combobox_data_akreditas_apiservice.class);
    }
}
