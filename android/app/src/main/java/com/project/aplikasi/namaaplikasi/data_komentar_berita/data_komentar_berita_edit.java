...
public class data_komentar_berita_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    loading.hideDialog();
					Toast.makeText( data_komentar_berita_edit.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
					
                }  else {
				
				String token = "Bearer " + new config_global().ambil(data_komentar_berita_edit.this);
                mAPIService.proses_update_data_komentar_berita(id_komentar_berita.getText().toString()
				...
				, token
                    ...
                    public void onResponse(Call<Object> call, Response<Object> response) {
                        Toast.makeText( data_komentar_berita_edit.this, "Berhasil Diupdate", Toast.LENGTH_LONG).show();
                        setResult(RESULT_OK);
						loading.hideDialog();
                        finish();
                    }
                    ...
                    public void onFailure(Call<Object> call, Throwable t) {
                        Toast.makeText( data_komentar_berita_edit.this, "Gagal Diupdate", Toast.LENGTH_LONG).show();
						loading.hideDialog();
                    }
                });
			 }
