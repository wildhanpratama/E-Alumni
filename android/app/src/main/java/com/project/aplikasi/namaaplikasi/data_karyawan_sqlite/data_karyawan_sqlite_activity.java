...
public class data_karyawan_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_karyawan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_karyawan_activity_v2);
        ...
        data_karyawan_tampil = (RecyclerView) findViewById(R.id.data_karyawan_tampil);
        data_karyawan_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_karyawan_sqlite_activity.this);
        data_karyawan_tampil.setLayoutManager(layoutManager);
        fetch_data_karyawan_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_karyawan_sqlite_activity.this, data_karyawan_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_karyawan_sqlite();
                Toast.makeText(data_karyawan_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_karyawan_sqlite(){
        dbHandler = new data_karyawan_sqlite_dbhandler( data_karyawan_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_karyawan_sqlite();
        adapter = new data_karyawan_sqlite_adapter(data_karyawan_sqlite_activity.this, datalist );
        data_karyawan_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        if (adapter.getItemCount() == 0){

            data_karyawan_tampil.setVisibility(View.GONE);
        } else {

            data_karyawan_tampil.setVisibility(View.VISIBLE);
            data_karyawan_tampil.addOnItemTouchListener(
                    new data_karyawan_sqlite_recyclerclick(getApplicationContext(), new data_karyawan_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_karyawan_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_karyawan_sqlite_activity.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.data_karyawan_pencarian, null);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_karyawan_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_karyawan_sqlite_dbhandler( data_karyawan_sqlite_activity.this);
        datalist = dbHandler.get_data_karyawan_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_karyawan_sqlite_adapter(data_karyawan_sqlite_activity.this, datalist );
        data_karyawan_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
