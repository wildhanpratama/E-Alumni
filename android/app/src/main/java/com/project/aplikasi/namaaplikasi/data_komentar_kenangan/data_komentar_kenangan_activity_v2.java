...
public class data_komentar_kenangan_activity_v2 extends AppCompatActivity {

    ArrayList<data_komentar_kenangan_apidata> result = new ArrayList<>();
    data_komentar_kenangan_adapter_v2 adapter;
    RecyclerView data_komentar_kenangan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_komentar_kenangan_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_komentar_kenangan_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_komentar_kenangan_activity_v2.this,
                        data_komentar_kenangan_tambah.class);
    ...
    public void fetch_data_komentar_kenangan(){
        ...
        mAPIService.tampil_data_komentar_kenangan(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_komentar_kenangan_api> call, Response<data_komentar_kenangan_api> response) {
				...
				int jumlah_data = data_komentar_kenangan_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_komentar_kenangan_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_komentar_kenangan_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_komentar_kenangan_activity_v2.this,
