...
public class data_sekolah_activity_v2 extends AppCompatActivity {

    ArrayList<data_sekolah_apidata> result = new ArrayList<>();
    data_sekolah_adapter_v2 adapter;
    RecyclerView data_sekolah_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_sekolah_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_sekolah_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_sekolah_activity_v2.this,
                        data_sekolah_tambah.class);
    ...
    public void fetch_data_sekolah(){
        ...
        mAPIService.tampil_data_sekolah(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_sekolah_api> call, Response<data_sekolah_api> response) {
				...
				int jumlah_data = data_sekolah_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_sekolah_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_sekolah_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_sekolah_activity_v2.this,
