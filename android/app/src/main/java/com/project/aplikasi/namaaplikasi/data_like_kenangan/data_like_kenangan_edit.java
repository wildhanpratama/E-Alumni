...
public class data_like_kenangan_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.data_like_kenangan_edit );
        ...
        id_like_kenangan.setText(bundle.getString("id_like_kenangan"));
        ...
        tombol_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    loading.hideDialog();
					Toast.makeText( data_like_kenangan_edit.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
					
                }  else {
				
				String token = "Bearer " + new config_global().ambil(data_like_kenangan_edit.this);
                mAPIService.proses_update_data_like_kenangan(id_like_kenangan.getText().toString()
				...
				, token
                    ...
                    public void onResponse(Call<Object> call, Response<Object> response) {
                        Toast.makeText( data_like_kenangan_edit.this, "Berhasil Diupdate", Toast.LENGTH_LONG).show();
                        setResult(RESULT_OK);
						loading.hideDialog();
                        finish();
                    }
                    ...
                    public void onFailure(Call<Object> call, Throwable t) {
                        Toast.makeText( data_like_kenangan_edit.this, "Gagal Diupdate", Toast.LENGTH_LONG).show();
						loading.hideDialog();
                    }
                });
			 }
