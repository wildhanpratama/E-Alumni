...
public class data_komentar_kenangan_sqlite_tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_komentar_kenangan.setText( config_global.generate_id( data_komentar_kenangan_sqlite_tambah.this,"data_komentar_kenangan") );
        ...
        button_tambahdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_komentar_kenangan_sqlite_tambah.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.tambah_data_komentar_kenangan_sqlite( new data_komentar_kenangan_sqlite_data(
                    ...
                    adapter = new data_komentar_kenangan_sqlite_adapter( data_komentar_kenangan_sqlite_tambah.this, data_komentar_kenangan_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_komentar_kenangan_sqlite_tambah.this, "Berhasil Menambahkan Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
