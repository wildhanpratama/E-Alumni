...
public class data_akreditas_apiutils {


    public static data_akreditas_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create( data_akreditas_apiservice.class);
    }
}
