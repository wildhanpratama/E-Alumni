...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <strong>Tambah Data Komentar Kenangan </strong>
        <hr class="message-inner-separator">
            <p>Silahkan input Data Komentar Kenangan  dibawah ini.</p>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="25%" class="leftrowcms">					
                                <label >Id Komentar Kenangan  <span class="highlight">*</span></label>
                            </td>
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_komentar_kenangan", "id_komentar_kenangan", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_komentar_kenangan", "id_komentar_kenangan", "10"); ?>" name="id_komentar_kenangan" placeholder="Id Komentar Kenangan " id="id_komentar_kenangan" required="required">
