...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-warning">
        ...
        <strong>Edit Data Komentar Kenangan </strong>
        <hr class="message-inner-separator">
            <p>Silahkan Update Data Komentar Kenangan  dibawah ini.</p>
        </div>
    </div>
        ...
        <div class="content-box-content">
            <div id="postcustom">	
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>	
                    ...
                    $sql = mysql_query("SELECT * FROM data_komentar_kenangan where id_komentar_kenangan = '$proses'");
                    $data = mysql_fetch_array($sql);
                    ?>
                    <!--h
                    <tr>
                        <td width="25%" class="leftrowcms">					
                            <label >Id Komentar Kenangan  <font color="red">*</font></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                           <?php echo $data['id_komentar_kenangan']; ?>	
                        </td>
                    </tr>
                    h-->
                    <input type="hidden" class="form-control" name="id_komentar_kenangan" value="<?php echo $data['id_komentar_kenangan']; ?>" readonly  id="id_komentar_kenangan" required="required">
