...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-warning">
        ...
        <strong>Edit Data Like Berita </strong>
        <hr class="message-inner-separator">
            <p>Silahkan Update Data Like Berita  dibawah ini.</p>
        </div>
    </div>
        ...
        <div class="content-box-content">
            <div id="postcustom">	
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>	
                    ...
                    $sql = mysql_query("SELECT * FROM data_like_berita where id_like_berita = '$proses'");
                    $data = mysql_fetch_array($sql);
                    ?>
                    <!--h
                    <tr>
                        <td width="25%" class="leftrowcms">					
                            <label >Id Like Berita  <font color="red">*</font></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                           <?php echo $data['id_like_berita']; ?>	
                        </td>
                    </tr>
                    h-->
                    <input type="hidden" class="form-control" name="id_like_berita" value="<?php echo $data['id_like_berita']; ?>" readonly  id="id_like_berita" required="required">
