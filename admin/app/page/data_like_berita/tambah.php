...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <strong>Tambah Data Like Berita </strong>
        <hr class="message-inner-separator">
            <p>Silahkan input Data Like Berita  dibawah ini.</p>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="25%" class="leftrowcms">					
                                <label >Id Like Berita  <span class="highlight">*</span></label>
                            </td>
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_like_berita", "id_like_berita", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_like_berita", "id_like_berita", "10"); ?>" name="id_like_berita" placeholder="Id Like Berita " id="id_like_berita" required="required">
