...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <strong>Tambah Data Komentar Berita </strong>
        <hr class="message-inner-separator">
            <p>Silahkan input Data Komentar Berita  dibawah ini.</p>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="25%" class="leftrowcms">					
                                <label >Id Komentar Berita  <span class="highlight">*</span></label>
                            </td>
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_komentar_berita", "id_komentar_berita", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_komentar_berita", "id_komentar_berita", "10"); ?>" name="id_komentar_berita" placeholder="Id Komentar Berita " id="id_komentar_berita" required="required">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <option></option><?php combo_database_v2('data_berita','id_berita','caption',''); ?>
                                </select>
                            </td>
                        </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="varchar" name="komentar" id="komentar" placeholder="Komentar " required="required">
                            </td>
                        </tr>
