...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_pertanyaan_akreditas");
} else {
    ...
    proses_action_cetak("data_pertanyaan_akreditas");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <center>
        <strong>LAPORAN
            ...
            <?php
            $tabelnya = "data_pertanyaan_akreditas";
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Pertanyaan Akreditas </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_pertanyaan_akreditas where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_pertanyaan_akreditas where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_pertanyaan_akreditas";
            }
