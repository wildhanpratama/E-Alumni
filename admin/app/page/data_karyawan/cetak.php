...
if (isset($_GET['input'])) {
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Karyawan </th> h-->
                ...
                <th align="center" class="th_border cell"  >Bidang Keahlian </th>
        ...
        <tbody>
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <!--h <td align="center"><?php echo $data['id_karyawan']; ?></td> h-->
                        ...
                        <td align="center"><?php echo $data['bidang_keahlian']; ?></td>
